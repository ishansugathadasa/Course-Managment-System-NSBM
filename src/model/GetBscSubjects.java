...
public class GetBscSubjects {
    ...
    public GetBscSubjects(String subjectCode, String admissionNo, double amount, String enrolledDate, String name, String courseId, String lecturerId, String labId, int year, int semester, boolean compulsary, int noOfCredites, double fee) {
